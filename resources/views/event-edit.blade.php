    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm: px-6 lg: px-8">
            ...
            <!-- Para ver la imagen seleccionada-->
                ...
                <div class="img">
                <label class="uppercase md: text-sm text-xs colorp text-light font-bold mb-1">Subir Imagen</label>
                    <div class='flex items-center justify-center w-full'>
                        <label class='flex flex-col border-4 border-dashed w-full h-32 hover:bg-gray-100 hover:border-purple-300 group'>
                            <div class='flex flex-col items-center justify-center pt-4'>
                            
                            <svg class="h-20 w-20 colorp"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  
                                <path stroke="none" d="M0 0h24v24H0z"/>  
                                <path d="M7 18a4.6 4.4 0 0 1 0 -9h0a5 4.5 0 0 1 11 2h1a3.5 3.5 0 0 1 0 7h-1" />  
                                <polyline points="9 15 12 12 15 15" /> 
                                 <line x1="12" y1="12" x2="12" y2="21" />
                            </svg>
                            <p class='text-sm colorp pt-1 tracking-wider'>Seleccione la imagen</p>
                            </div>
                ...
                <div class="grid grid-cols-1 mt-5 mx-7">
                    <label class="uppercase md:text-sm text-xs colorp text-light font-bold">Titulo</label>
                ...
                <div class="grid grid-cols-1 grid-cols-2 md:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7">
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs colorp text-light font-bold">Fecha:</label>
                        <input name="date" value="{{ $event->date }}" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="date" required/>
                    </div>
                    <div class="grid grid-cols-2">
                        <label class="uppercase md:text-sm text-xs colorp text-light font-bold">Hora:</label>
                        <input value="{{ $event->hour }}" type="time" name="hour" value="08:00:00" max="23:00:00" min="00:00:00" list="listTime" step="1" required class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent">
                    </div> 
                    <div class="grid grid-cols-3">
                        <label class="uppercase md:text-sm text-xs colorp text-light font-bold">Duración:</label>
                        <input name="duration" value="{{ $event->duration}}" class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" required/>
                    </div>
                </div>
                <div class="grid grid-cols-1 grid-cols-2 md:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7">
                    <div class="grid grid-cols-1">
                        <label class="uppercase md:text-sm text-xs colorp text-light font-bold">Máximo de Participantes:</label>
                    ...
                    <div class="grid grid-cols-2">
                        <label class="uppercase md:text-sm text-xs colorp text-light font-bold">Mínimo de Participantes:</label>
                    ...
                    <div class="grid grid-cols-3">
                        <label class="uppercase md:text-sm text-xs colorp text-light font-bold">Precio:</label>
                        ...
                        <span class="text-6xl colorp font-semibold py-4 px-3"> &#8364 </span>
                    </div>
                </div>
                <div class="grid grid-cols-1 mt-5 mx-7">
                    <label class="uppercase md:text-sm text-xs colorp text-light font-bold">Descripción:</label>
                ...
                <div class="grid grid-cols-1 mt-5 mx-7">
                    <label class="uppercase md:text-sm text-xs colorp text-light font-bold">Incluido:</label>
