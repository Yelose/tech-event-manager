                ...
                <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center">
                            <a class="bg-main inline-flex text-white items-center md:mb-2 px-6 py-4 rounded-full mr-14" href="/show/{{$event->id}}">Ver</a>
                            @auth
                            <a class="bg-main inline-flex text-white items-center md:mb-2 px-6 py-4 rounded-full mr-14" href="#">inscribirse</a>
                            @else
                            <a class="bg-main inline-flex text-white items-center md:mb-2 px-6 py-4 rounded-full mr-14" href="/login">inscribirse</a>
                            @endauth
                        </div>
                    </div>
                </div>
