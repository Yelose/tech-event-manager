...
? 'inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 text-white-900 focus:outline-none focus:border-white-700 transition duration-150 ease-in-out'
