                ...
                <div class="card ">
                    <div >
                        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg">
                            <img class="lg:h-72 md:h-48 w-full object-cover object-center" src="{{$event->image}}"
                                alt="lugar">
                            <div class="p-6">
                                ...
                                <div class="flex items-center">
                                    <a class=" inline-flex items-center md:mb-2 px-6 py-4 bg-purple-600 rounded-full mr-20" href="/show/{{$event->id}}">Read More</a>
                                    @auth
